...
const NhanVienItem = ({ maNV, tenNV, phai, noiSinh, luong, phongBan, onDeleteClick, onUpdateClick }) => {
  return (
    <tr className="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700">
      ...
      <td className="px-6 py-4">
        {phai === "NU" ? <i className="fa-solid fa-venus text-2xl"></i> : <i className="fa-solid fa-mars text-2xl"></i>}
      </td>
